...
CUBIE_MOVES = {
    "U": [([0, 0, 0, 0], [0, 0, 2, 2], [0, 2, 2, 0]),  # corner
          ([0, 0, 0, 0], [0, 1, 2, 1], [1, 2, 1, 0])],  # edge
    "L": [([0, 0, 2, 2], [0, 2, 2, 0], [0, 0, 0, 0]),
          ([0, 1, 2, 1], [1, 2, 1, 0], [0, 0, 0, 0])],
    "F": [([0, 0, 2, 2], [2, 2, 2, 2], [0, 2, 2, 0]),
          ([0, 1, 2, 1], [2, 2, 2, 2], [1, 2, 1, 0])],
    "R": [([0, 2, 2, 0], [0, 0, 2, 2], [2, 2, 2, 2]),
          ([0, 1, 2, 1], [1, 0, 1, 2], [2, 2, 2, 2])],
    "B": [([0, 2, 2, 0], [0, 0, 0, 0], [0, 0, 2, 2]),
          ([0, 1, 2, 1], [0, 0, 0, 0], [1, 0, 1, 2])],
    "D": [([2, 2, 2, 2], [0, 2, 2, 0], [0, 0, 2, 2]),
          ([2, 2, 2, 2], [0, 1, 2, 1], [1, 0, 1, 2])]
}
